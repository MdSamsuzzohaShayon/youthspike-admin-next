    ...
    return (
        <div className='h-screen w-full flex'>
            <div className="w-full md:w-3/6 relative">
                <div className='container mx-auto px-2 w-full h-full flex justify-center items-center flex-col gap-2 absolute'>
            ...
            <div className="md:w-3/6 hidden md:flex justify-center items-center">
                <h1>Login to access as admin to league director</h1>
            </div>
        </div>
    );
}
