...
import { GET_LEAGUES } from '@/graphql/queries/leagueQueries';
import { ADD_UPDATE_LEAGUE } from '@/graphql/mutations/leagueMutations';
        ...
        <div className="w-[calc((w-screen)-(w-1/5)) overflow-hidden flex justify-between pb-4 pt-2">
          ...
          {userRole == 'admin' && (
            <div className="flex flex-row-reverse pl-4">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="ionicon w-7 h-7 mr-2" viewBox="0 0 512 512">
                  <path
                        ...
                        <div className="flex item-center justify-center">
                          <div className="relative">
                            <button
                              ...
                              onClick={() => toggleMatch(league?._id)}
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
