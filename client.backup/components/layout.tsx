...
import { CHANGE_PASSWORD } from "@/graphql/coach";
          ...
          <div className="w-1/6 drop-shadow-xl bg-slate-700 border-r border-gray-200 pb-5">
            <div className="flex-1 py-4 space-y-1 bg-slate-700 divide-y divide-gray-200 dark:divide-gray-700">
              <Link href="/leagues">
                ...
                >
                  <Image src="/icons/trophy-white.svg" width="35" height="35" alt="trophy-white" />
                  Leagues
                </button>
              </Link>
              ...
              <Link href="/teams">
                ...
                >
                  <Image src="/icons/teams-white.svg" width="35" height="35" alt="teams-white" />
              ...
              {user?.role === 'admin' && (<Link href="/coaches">
                ...
                >
                  <Image src="/icons/coaches-white.svg" width="35" height="35" alt="coaches-white" />
                  Coaches
                </button>
              </Link>)}
              ...
              <Link href="/players">
                ...
                >
                  <Image src="/icons/players-white.svg" width="35" height="35" alt="players-white" />
                  Players
                </button>
              </Link>
              ...
              <Link href={"/matches"}>
                ...
                >
                  <Image src="/icons/matches-white.svg" width="35" height="35" alt="matches-white" />
